...
| Taxonomy edits do not silently erase previous reasoning or override a correction | `graph-loop.test.ts` "taxonomy edits version the definitions without erasing edges or corrections" | not yet |
